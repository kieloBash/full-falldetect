import { ADMIN_SENSOR_STATUS_META } from "@/lib/admin/constants";
...
/** Plain colored status pill used in the rooms table (no icon — distinct from Live Monitor's StatusBadge). */
export function SensorStatusPill({ status }: SensorStatusPillProps) {
  const meta = ADMIN_SENSOR_STATUS_META[status];
  return (
    <span
